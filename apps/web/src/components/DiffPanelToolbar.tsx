...
import { isTurnDiffSummaryReviewable, resolveTurnDiffMenuStatus } from "~/turnDiffAvailability";
import {
...
function resolveScopeMenuIcon(scope: RepoDiffScope | "lastTurn", vcsBackend: VcsBackend | null) {
  switch (scope) {
    case "unstaged":
